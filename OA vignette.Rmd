...
4.  Testing Results Against WoS and Scopus
...
```{r fetching results,include=T,eval=F,echo=T}
...
# Testing results against WoS and Scopus
```{r comparing WoS and OA,include=T,eval=T,echo=T}
...
```{r plotting oa and wos,include=T,eval=T,echo=T}
p <- ggplot() +
  ...
  labs(title = "Distribution of Relevance Scores (80-200)",
       subtitle = "OpenAlex Only (blue) vs. Matched in WoS (green) [Log Scale]",
       x = "Relevance Score",
